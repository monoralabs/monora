...
export const useCases = {
  ...
  createGroup: createGroupUseCase(deps),
  renameGroup: renameGroup(deps),
  deleteGroup: deleteGroup(deps),
  addGroupMember: addGroupMember(deps),
  removeGroupMember: removeGroupMember(deps),
  grantGroupAccess: grantGroupAccess(deps),
  revokeGroupAccess: revokeGroupAccess(deps),
